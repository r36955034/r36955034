...
const nav = [
  ...
  { hash: "why", label: "Why JSA" },
  { hash: "features", label: "Features" },
  { hash: "curriculum", label: "Curriculum" },
  { hash: "photos", label: "Photos" },
...
function SiteHeader() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "bg-ivory/85 backdrop-blur-xl border-b border-gold/20 shadow-soft" : "bg-transparent"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "group flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-10 w-10 place-items-center rounded-full border border-gold/40 bg-ivory/60 text-gold-deep font-sanskrit text-lg shadow-soft transition-transform group-hover:rotate-12", children: "ॐ" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-lg tracking-wide text-maroon", children: "Jain Sanskar Arohan" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-[0.3em] text-gold-deep", children: "Est. 2017" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden items-center gap-1 lg:flex", children: [
            nav.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                className: "relative px-4 py-2 text-sm font-medium text-ink/75 transition-colors hover:text-maroon",
                children: n.label
              },
              n.hash
            )),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: "https://jainsanskararohan.github.io/dashboard/",
                target: "_blank",
                rel: "noreferrer",
                className: "ml-3 inline-flex items-center gap-2 rounded-full border border-gold/50 px-5 py-2.5 text-sm font-medium text-maroon transition-all hover:bg-gold/10 hover:-translate-y-0.5",
                children: "Dashboard"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: "https://forms.gle/gZQ21DsV6QemBX3m7",
                target: "_blank",
                rel: "noreferrer",
                className: "ml-2 inline-flex items-center gap-2 rounded-full bg-gradient-maroon px-5 py-2.5 text-sm font-medium text-ivory shadow-soft transition-all hover:shadow-sacred hover:-translate-y-0.5",
                children: "Register"
              }
            )
          ] }),
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-gold/20 bg-ivory/95 backdrop-blur-xl lg:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col p-4", children: [
          nav.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: `/#${n.hash}`,
              onClick: goToHash(n.hash),
              className: "rounded-md px-4 py-3 text-sm font-medium text-ink/80 hover:bg-secondary",
              children: n.label
            },
            n.hash
          )),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              target: "_blank",
              rel: "noreferrer",
              className: "mt-2 rounded-full border border-gold/50 px-5 py-3 text-center text-sm font-medium text-maroon",
              children: "Dashboard"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              target: "_blank",
              rel: "noreferrer",
              className: "mt-2 rounded-full bg-gradient-maroon px-5 py-3 text-center text-sm font-medium text-ivory",
              children: "Register"
            }
          )
        ] }) })
...
function Ornament({ className = "" }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 200 24", className, fill: "none", xmlns: "http://www.w3.org/2000/svg", "aria-hidden": true, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M0 12h70", stroke: "currentColor", strokeWidth: "0.6" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M130 12h70", stroke: "currentColor", strokeWidth: "0.6" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "100", cy: "12", r: "3.5", stroke: "currentColor", strokeWidth: "0.8" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "100", cy: "12", r: "1", fill: "currentColor" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M85 12c4-6 11-6 15 0-4 6-11 6-15 0z", stroke: "currentColor", strokeWidth: "0.6" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M115 12c-4-6-11-6-15 0 4 6 11 6 15 0z", stroke: "currentColor", strokeWidth: "0.6" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "78", cy: "12", r: "1.2", fill: "currentColor" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "122", cy: "12", r: "1.2", fill: "currentColor" })
  ] });
}
function SectionLabel({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divider-ornate mx-auto max-w-md text-xs uppercase tracking-[0.4em]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children }) });
}
function SiteFooter() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "relative mt-32 border-t border-gold/30 bg-gradient-to-b from-transparent to-ivory-deep/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 py-16 lg:px-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center text-gold-deep mb-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Ornament, { className: "h-5 w-48" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-12 md:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-10 w-10 place-items-center rounded-full border border-gold/40 text-gold-deep font-sanskrit", children: "ॐ" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-xl text-maroon", children: "Jain Sanskar Arohan" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-13 mb-4 text-[11px] uppercase tracking-[0.25em] text-gold-deep", children: "Created by Rajat Surana" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: "A spiritual educational program nurturing seekers of all ages in the timeless wisdom of Jain philosophy since 2017." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs uppercase tracking-[0.3em] text-gold-deep mb-4", children: "Explore" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 text-sm", children: [
          ...
          ["Results", "results"],
          ["Contact", "contact"]
        ].map(([l, h]) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: `#${h}`, className: "text-ink/70 hover:text-maroon", children: l }) }, h)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs uppercase tracking-[0.3em] text-gold-deep mb-4", children: "Connect" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-ink/80", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "jainsanskararohan@gmail.com" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Rupesh Chordia · +91 97101 80000" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Manjula Mehta · +91 98416 02255" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 border-t border-gold/20 pt-6 text-center text-xs text-muted-foreground space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-sanskrit text-gold-deep", children: "मिच्छामि दुक्कड़म्" }),
        " · © ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Jain Sanskar Arohan · All rights reserved"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "italic text-gold-deep/80", children: "Inspired by Rajagurumata Umrao Kawarji Marasa Mahasati Mandal" })
    ] })
  ] }) });
}
const appCss = "/assets/styles-MSXrG-Zi.css";
...
const Route$1 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Jain Sanskar Arohan — Learning Jain Principles, Made Simpler" },
      { name: "description", content: "A structured spiritual education program guiding seekers of all ages through ten levels of Jain philosophy, scripture, and values. Since 2017." },
      { property: "og:title", content: "Jain Sanskar Arohan — Learning Jain Principles, Made Simpler" },
      { property: "og:description", content: "A structured spiritual education program guiding seekers of all ages through ten levels of Jain philosophy, scripture, and values. Since 2017." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Jain Sanskar Arohan — Learning Jain Principles, Made Simpler" },
      { name: "twitter:description", content: "A structured spiritual education program guiding seekers of all ages through ten levels of Jain philosophy, scripture, and values. Since 2017." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/3f1b591f-f71d-4e8b-bf59-8cbf90a2fcdb/id-preview-8062a3f5--338a59f7-c1a5-4315-a294-03b89b5dbece.lovable.app-1777629178749.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/3f1b591f-f71d-4e8b-bf59-8cbf90a2fcdb/id-preview-8062a3f5--338a59f7-c1a5-4315-a294-03b89b5dbece.lovable.app-1777629178749.png" }
    ],
    links: [
      {
        rel: "stylesheet",
...
const $$splitComponentImporter = () => import("./index-D0goFpDN.js");
